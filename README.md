...
Zone Rouge : Coeur du Datacenter
...
Zone Rouge : Deux scripts distincts pour la configuration des capteurs RFID, de température, d'humidité, de fumée, et de présence.


Zone Jaune : Script configurant les détecteurs de présence, de fumée, et les capteurs de température et d'humidité.


Zone Verte : Script pour les capteurs de température, d'humidité, et de fumée.
...
Chaque code de zone  doit être lié  à son esp8266  à l'exeption de la zone rouge qui en  raison de son grand nombre de capteurs necessite un deuxième esp (manque de digital pin)  une fois les paramètres du broker et wifi  modifiés dans le code il fautdra tout téléverser les codes et observer avec un sub les topics 
